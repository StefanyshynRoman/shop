...
import com.example.order.exception.UnKnowDeliverTypException;
...
public class OrderService {
    ...
    private Order save(Order order) {
        Deliver deliver = deliverRepository.findByUuid(order.getDeliver().getUuid()).orElseThrow(UnKnowDeliverTypException::new);
