...
import { PostProduct } from '../../../../../core/models/forms.models';
...
export class AddProductFormComponent {
  ...
  categories: BehaviorSubject<Category[]> = this.categoriesServices.categories;
  ...
  addProduct() {
    ...
    this.productsService.addProduct(addProductData).subscribe({
      next: () => {
        ...
        this.imageUrls = [];
        this.successMessage = 'Poprawnie dodano product do sklepu';
      },
      error: (err) => {
